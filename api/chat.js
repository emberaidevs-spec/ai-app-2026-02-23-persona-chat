export default async function handler(req, res) {
  try {
    ...
    if (!req.body || !req.body.persona || !req.body.topic || !req.body.message) {
    ...
    const { persona, topic, message } = req.body;
    const systemPrompt = `You are ${persona}, a knowledgeable and empathetic expert in ${topic}. Respond to the user's message in a personalized and supportive manner, providing advice and guidance when needed. Be engaging, friendly, and non-judgmental.`;
